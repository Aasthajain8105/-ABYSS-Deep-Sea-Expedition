...
const CREATURES = [
  ...
  { id: 'staghorn_coral', name: 'Staghorn Coral', depthM: 10, x: 82, type: 'coral', color: '#e8b060', glow: '#ffd080', size: 70, fact: 'Fastest-growing hard coral — up to 20cm/year. Critically endangered due to thermal bleaching events.', stationary: true },
  ...
  { id: 'moray_eel', name: 'Giant Moray Eel', depthM: 90, x: 15, type: 'eel', color: '#4a5a2a', glow: '#7a9a3a', size: 95, fact: 'Has a second set of jaws in its throat (pharyngeal jaws) that extend forward to pull prey inward — like the Alien film.' },
  ...
  // ══════ TITANIC (3,784m) — rendered separately ══════
...
const ZONE_MARKERS = [
  { depthM: 200, label: 'TWILIGHT ZONE', sublabel: 'Mesopelagic • 200–1,000m', color: '#818cf8' },
  { depthM: 1000, label: 'MIDNIGHT ZONE', sublabel: 'Bathypelagic • 1,000–4,000m', color: '#6366f1' },
  { depthM: 4000, label: 'ABYSSAL ZONE', sublabel: 'Abyssopelagic • 4,000–6,000m', color: '#00f3ff' },
  { depthM: 6000, label: 'HADAL ZONE', sublabel: 'Hadal Trench • 6,000–11,000m', color: '#c4b5fd' },
];
...
export default function OceanDepthScroll({ onCreatureClick, onTitanicClick, depthRatio, currentDepth }) {
  ...
  // Track viewport depth for background color
  const bgStyle = {
    background: getBgGradient(currentDepth),
